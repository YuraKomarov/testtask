<?php
//
//AddEventHandler("iblock", "OnIBlockPropertyBuildList", array("MyCurledType", "GetUserTypeDescription"));
//
...
//            "USER_TYPE" => "Link",
//            "DESCRIPTION" => "Ссылка",
//            "GetPropertyFieldHtml" => array("MyCurledType", "GetPropertyFieldHtml")
//        );
//    }
//
